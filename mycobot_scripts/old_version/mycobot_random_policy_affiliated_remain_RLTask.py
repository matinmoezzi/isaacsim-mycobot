...
class RLTask(BaseTask):
    ...
    def __init__(self, name, env, offset=None) -> None:
        ...
        # there is no defining of _cfg from config folder but 
...
class MyCobot(Robot):
    def __init__(
        ...
        if self._usd_path is None:
            ...
            # self._usd_path = "/home/chay/OmniIsaacGymEnvs/omniisaacgymenvs/myCobot_model/mycobot_with_instance.usd"
...
class myCobotTask(RLTask):
    def __init__(
        ...
        self._num_envs = 16 # self._task_cfg["env"]['numEnvs'] # 512
